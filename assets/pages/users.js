...
async function handleStatusSwitch(event) {
  ...
  if (confirm(`¿Estás seguro de que deseas ${actionText} este usuario?`)) {
    try {
      await userService.changeStatusUser(userId, newStatus); // Esta función maneja el cambio de estado
    ...
    <tr>
      <td class="px-0">
        <div class="d-flex align-items-center">
          <img src="./assets/images/profiles/profile-1.png" class="rounded-circle" width="40" alt="flexy" />
          <div class="ms-3">
